...
epsilon_EKF = EKFOut.epsilon;
t_EKF = EKFOut.t;
statVis_EKF = EKFOut.statVis;
X_EKF = EKFOut.XEst;

    %% Calculate residual RMS errors
RMS_postfit_EKF = calcPostFitRMS(epsilon_EKF, stations, statVis_EKF);
...
colors = ['b', 'r'];
fig_EKFRes = plotPostFitRes(t_EKF, postfit_res_EKF, titleText, xLabel, yLabel, colors);
...
fig_EKFError = plotStateError(t_EKF, stateError_EKF, sigma_EKF, boundLevel, titleText, xLabel, yLabel);

    %% Assign output
EKFRun = struct("EKFOut", EKFOut, "t_EKF", t_EKF, "X_EKF", X_EKF, ...
                "RMS_postfit_EKF", RMS_postfit_EKF, "RMS_state_comp_EKF", RMS_state_comp_EKF, ...
                "RMS_state_full_EKF", RMS_state_full_EKF, "fig_EKFRes", fig_EKFRes, "fig_EKFError", fig_EKFError);
