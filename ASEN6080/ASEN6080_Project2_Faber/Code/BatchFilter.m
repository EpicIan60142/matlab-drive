function filterOut = BatchFilter(Xstar0, stations, pConst, scConst, P0, x0, dt, kEnd)
...
for k = 2:kEnd
    ...
    [t_int, XPhi_i] = ode45(@(t,XPhi)STMEOM_MuSunSRP(t,XPhi,pConst,scConst), tspan, XPhi_im1, opt);
