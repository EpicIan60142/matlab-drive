function EKFRun = runIEKF_DMC(X0, P0, B, Qu, pConst, scConst, stations, X_ref, t_ref, t_start, t_end, plot)
...
if any(~plot)
    ...
    %% Run EKF
EKFOut = IEKF_DMC(X0_EKF, stations, pConst, scConst, P0_EKF, B, Qu, t_EKF_start, t_EKF_end);
...
stateError_EKF = X_EKF(1:7,:)' - X_ref_EKF;
...
if plot(7) || plot(8)
    ...
    titleText = "IEKF Estimated State Difference (X_{filt} - X_{ref})";
    xLabel = "Time [sec]";
