function filterOut = LKF(Xstar0, stations, pConst, scConst, P0, x0, t_start, numMeas)
...
for k = kStart+1:kStart+numMeas
    ...
    [~, XPhi_full] = ode45(@(t,XPhi)STMEOM_MuSunSRP(t,XPhi,pConst,scConst), [t_im1 t_i], XPhi_full, opt);
    ...
    [~, XPhi_i] = ode45(@(t,XPhi)STMEOM_MuSunSRP(t,XPhi,pConst,scConst), [t_im1 t_i], XPhi_im1, opt);
...
filterOut.t = t(kStart+1:kStart+numMeas); % t_0 not included in estimate
