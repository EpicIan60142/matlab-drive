function EKFRun = runEKF(X0, P0, pConst, scConst, stations, X_ref, t_ref, t_start, t_end, plot)
% Function that runs an EKF on the given data for a stat OD problem. 
%   - Inputs: 
...
if any(~plot)
    ...
    %% Run EKF
EKFOut = EKF(X0_EKF, stations, pConst, scConst, P0_EKF, t_EKF_start, t_EKF_end);
