function LKFRun = runLKF_DMC(X0, x0, P0, B, Qu, pConst, scConst, stations, X_ref, t_ref, t_start, numMeas, numIter, plot)
...
while LKFRuns < maxLKFRuns
        % Run LKF
    LKFOut = LKF_DMC(X0_LKF, stations, pConst, scConst, P0_LKF, x0_LKF, B, Qu, t_start, numMeas);
...
stateError_LKF = X_LKF(1:7,:)' - X_ref_LKF;
