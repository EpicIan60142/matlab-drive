function dX = orbitEOM_MuJ2J3(t,X,mu,J2,J3,Ri)
% Function for the equations of motion for a body in orbit around a central
% body including mu, J2, and J3 in the 2 body problem
%   Inputs:
...
xDDot = -(mu*x/(r^3))*(1 + (((Ri/r)^2)*J2*((15/2)*(z/r)^2-(3/2))) + (((Ri/r)^3)*J3*((35/2)*(z/r)^3-(15/2)*(z/r))));
yDDot = -(mu*y/(r^3))*(1 + (((Ri/r)^2)*J2*((15/2)*(z/r)^2-(3/2))) + (((Ri/r)^3)*J3*((35/2)*(z/r)^3-(15/2)*(z/r))));
zDDot = -(mu*z/(r^3))*(1 + (((Ri/r)^2)*J2*((15/2)*(z/r)^2-(9/2)))) - (mu/(r^2))*((Ri/r)^3)*J3*((35/2)*(z/r)^4-15*(z/r)^2+(3/2));
