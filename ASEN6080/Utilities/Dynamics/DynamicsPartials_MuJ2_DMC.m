function Aprime = DynamicsPartials_MuJ2_DMC(X, B, mu, J2, Ri)
% Function that outputs the acceleration partials matrix for orbital 
% dynamics including contributions from mu and J2, including dynamic model 
% compensation.
%   Inputs:
...
%
%   Outputs:
%       - Aprime: Acceleration partials matrix with DMC
%
