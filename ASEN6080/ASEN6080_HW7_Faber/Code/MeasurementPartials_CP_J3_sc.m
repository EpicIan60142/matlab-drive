function [Htilde_x, Htilde_c] = MeasurementPartials_CP_J3_sc(X,X_s)
% Function that outputs the measurement partials matrix for orbital
% measurements using range and range rate for spacecraft, including J3 as a
% consider parameter
%   Inputs:
...
%
%   Outputs:
%       - Htilde_x: Measurement partials matrix with respect to state
%       - Htilde_c: Measurement partials matrix with respect to consider
%                   parameters
%
...
Htilde_x = [
              delRhoDelX, delRhoDelY, delRhoDelZ, zeros(1,3);
              delRhoDotDelX, delRhoDotDelY, delRhoDotDelZ, delRhoDotDelXDot, delRhoDotDelYDot, delRhoDotDelZDot
           ];
