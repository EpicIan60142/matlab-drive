function [t, Y, R, vis] = processStations(stations, t_start)
...
%            where a measurement was made
%       - vis: Cell array of station indices that can see the spacecraft at
%              the time of measurement, one vector for every time in t:
