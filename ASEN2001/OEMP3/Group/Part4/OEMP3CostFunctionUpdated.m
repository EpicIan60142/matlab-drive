...
% Group 11, 10:40 Lab
%
% Code by: Ian Faber and Nathan Evans
...
Material = ["Aluminum 6061", "Steel 4130", "Nickel Inconel 600", "Stainless Steel 17-4", "Titanium 6AL-4V"];
%% Hollow Square
for i = 1:5
...
weight = volume * rho;
hollowFinal.cost = weight * price(i);
hollowFinal.material = Material(i)
end
