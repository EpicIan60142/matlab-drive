...
TOW = mod(seconds(tDiff), 7*24*60*60);
    ...
    % Extract clock correction and satellite position
...
elevationCutoff = 10; % Ignore elevations below this angle
