function [health,satPos,satVel,satClkCorr,relCorr,junk,tgd] = eph2pvtWithRel(ephemeris,t_input,prn)
...
% Modified by I. Faber to add relativity correction (10/03/2025)
...
for tt = 1:sz % loop through all input times
    ...
    relCorr(tt,1) = -2*dot(satPos(tt,:), satVel(tt,:))/c; % return in meters, negative sign to follow IS-GPS documentation
    junk = 0;
