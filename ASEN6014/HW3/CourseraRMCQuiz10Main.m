%% ASEN 6014 Coursera Relative Motion Control Quiz 10 Main
...
X0 = [X0_c; X0_d];
    ...
    % Define tspan to output at specified times 0s, 7500s, and 15000s
tspan = 0:10:21000;

    % Run controller
[t, X] = ode45(@(t,X)OESMAFeedbackControlElems(t,X,doe_r,kConst,pConst), tspan, X0, opt);
