%% ASEN 6014 Formation Flying Coursera Quiz 5 Main Script
...
[t_N, X_N] = ode45(@(t,X)multiSatOrbitEOM(t,X,const,scConst,false), tspan, X0_N, opt);
...
[t_rel, X_rel] = ode45(@(t,X)fullLinGenRelEOM(t,X,const), tspan, X0, opt);
