...
%
    ...
    %fprintf("Time: %.3f, Location: [%.3f, %.3f], Velocity: [%.3f, %.3f], Thrust: [%.3f, %.3f], mass; %f kg, water volume: %.5f, initial volume: %.5f, flight state: %s\n", t, x, z, vx, vz, fThrust(1), fThrust(2), m, const.Vbottle - Vair, const.VWaterInit, flightState);
