%% ASEN 3128 Lab 4 Problem 7 Script
...
[time, state] = ode45(@(t, var)QuadrotorEOMwithControlVelocity(t, var, g, m, nu, mu), tspan, X0, options);
...
for k = 1:length(time)
    [Fc, Gc] = VelocityReferenceFeedback(time(k), aircraft_state_array(:,k));
