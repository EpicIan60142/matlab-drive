function var_dot = QuadrotorEOM_Linearized(t, var, g, m, I) 
...
[Fc_control , Gc_control] = InnerLoopFeedback(var);

Fc_trim = [0; 0; -m*g];

Fc = Fc_control - Fc_trim;
...
deltaLc = Gc_control(1);
deltaMc = Gc_control(2);
deltaNc = Gc_control(3);
...
deltauvwDot = g.*[-deltatheta; deltaphi; 0] + (1/m).*Fc;
