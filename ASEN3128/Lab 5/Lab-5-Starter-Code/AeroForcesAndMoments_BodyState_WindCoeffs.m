...
CD = ap.CDpa + ap.K*CL*CL; %%%% Where is CLmin??
...
Thrust = density*ap.Sprop*ap.Cprop*(V + dt*(ap.kmotor - V))*dt*(ap.kmotor-V); %% mSmall UAS model as described in http://uavbook.byu.edu/lib/exe/fetch.php?media=shared:propeller_model.pdf
