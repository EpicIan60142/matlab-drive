...
%% Propagate orbits and attitude with GMO-pointing control
out_LMO = RK4_Orbit(x_0_LMO, t0, dt, tf);
out_GMO = RK4_Orbit(x_0_GMO, t0, dt, tf);

out_Attitude = RK4_Attitude(x_0_att, t0, dt, tf, 'GMO pointing', out_LMO, out_GMO, controlParams);
