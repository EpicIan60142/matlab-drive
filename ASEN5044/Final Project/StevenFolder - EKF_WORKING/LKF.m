...
for k = 1:length(y)-1 % Go to length(y) - 1 because correction step takes data from time k+1
    ...
    if noMeas % Don't correct if measurements are turned off
        ...
        % for points = [54, 55, 56, 101, 102, 103, 148, 149, 150, 195, 196, 197, 242, 243, 244, 289, 290, 291, 345, 346, 347, 390, 391, 392, 436, 437, 438, 484, 485, 486, 532, 533, 534]
        %     if k == points
