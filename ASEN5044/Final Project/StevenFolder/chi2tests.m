function [epsilon_x_bar, epsilon_y_bar, NEESbounds, NISbounds, xtrue, ytrue, filterData] = chi2tests(filterFunc, N, alpha, filterParams, Qtrue, Rtrue, filterInit, timesteps, x0)
